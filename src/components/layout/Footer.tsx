...
export default function Footer() {
	return (
		<footer className="bg-[url('/YAHO_logo/Subtract.png')] bg-cover bg-no-repeat bg-center text-white h-full w-full">
			...
			<div className="flex flex-col lg:flex-row justify-between xl:p-32 xl:mt-24 lg:p-24 lg:mt-20 pt-30 sm:px-30 px-10 pb-10 mt-20 gap-10">
				{/* 左側聯絡資訊 */}
				...
				{/* 右側 Logo + 著作權 + 連結 */}
				<div className="lg:text-center md:text-left space-y-4 w-full ">
					{/* Logo 圖片（請根據實際路徑調整） */}
