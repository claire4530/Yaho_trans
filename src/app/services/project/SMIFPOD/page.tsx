...
export default function IntroductionPage() {
    ...
    const images = [
        "/services/project/SMIFPOD/1.png",
        "/services/project/SMIFPOD/2.png",
        "/services/project/SMIFPOD/3.png",
        "/services/project/SMIFPOD/4.png",
        "/services/project/SMIFPOD/5.png",
        "/services/project/SMIFPOD/6.png", 
    ]
            ...
            <Breadcrumb className="px-8 pt-5 sm:pt-8 w-full">
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            {/* SMI POD */}
                            <Link href="/services/project/SMIFPOD" className="text-sm sm:text-base font-semibold">{t("project.SMIFPOD")}</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
