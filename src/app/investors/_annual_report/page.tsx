...
export default function OrganizationPage() {
    ...
    const revenueReports = [
        { title: "2025年度股東會年報", url: "/pdf/2025.pdf" },
        { title: "2024年度股東會年報", url: "/pdf/2024.pdf" },
        { title: "2023年度股東會年報", url: "/pdf/2023.pdf" },
        { title: "2022年度股東會年報", url: "/pdf/2022.pdf" },
        { title: "2021年度股東會年報", url: "/pdf/2021.pdf" },
        { title: "2020年度股東會年報", url: "/pdf/2020.pdf" },
    ];
        ...
        <div className="overflow-x-hidden">
            ...
            <Breadcrumb className="px-8 pt-5 sm:pt-8 w-full">
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link href="/investors/annual_report" className="text-sm sm:text-base font-semibold">{t("shareholders_meeting_report")}</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
