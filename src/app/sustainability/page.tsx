...
//   const t = useTranslations("sustainability");
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* 三張卡片 */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-8 pb-12 max-w-7xl mx-auto">
        {sections.map((section, index) => (
          <Link href={section.href} key={index}>
            <Card className="pt-0  rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 cursor-pointer overflow-hidden">
